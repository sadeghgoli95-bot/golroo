 ...
 * see lib/analytics/traffic/googleAnalyticsAdapter.ts. Routed through
 * limitedRequest so every caller across the whole dashboard — no matter
 * how many nested Promise.all calls fan out — shares one global
 * concurrency cap against GA4's concurrent-request quota.
 */
